## Version 3.5.1 - March 11, 2026
  * Update to volcano-core 4.1.0, slf4j-api 2.0.12, logback-classic 1.3.15

## Version 3.5.0 - August 15, 2025
  * Fixes many issues with SeedLink 
  * Replaced vulnerable log4j with logback

## Version 3.4.2 - April 18, 2025
  * Change default scroll size for Helicorder to automatically adjust to the view size
  * Update wwsclient to version 3.0.0

## Version 3.4.1 - March 19, 2025
  * Change default source from AVO WWS to EarthScope DMC SeedLink Server

## Version 3.4.0 - March 12, 2025
  * Add "User Guide" and "Version History" to Help menu

## Version 3.3.4 - October 16, 2024
  * Add support for getting station information from portable-fdsnws-dataselect
  * Modify the web services data source to not allow real-time
  * Add optional TRUST_ALL_CERTS system property to trust all certificates
    java -DTRUST_ALL_CERTS=true -jar swarm.jar
