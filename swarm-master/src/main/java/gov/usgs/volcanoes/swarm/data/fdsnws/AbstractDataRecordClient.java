...
public abstract class AbstractDataRecordClient {
  ...
  private static Wave createWave(DataRecord dr, Blockette1000 b1000) throws UnsupportedCompressionType, CodecException {
    ...
    final DecompressedData decomp = codec.decompress(type, data, dr.getHeader().getNumSamples(), swapNeeded);
  ...
  protected static String getDateText(Date date) {
    return SwarmUtil.getDateText(date);
  }
